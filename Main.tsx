...
import { Text, TextInput, Button, Appbar, Dialog } from 'react-native-paper';
...
export default function Main() {
  ...
  // Request camera permission when opening scanner
  useEffect(() => {
  ...
  // Settings screen
  if (isUnlocked && isSettings) {
    return (
      <View style={styles.container}>
        <Text variant="headlineMedium" style={styles.heading}>Settings</Text>
        <Button mode="outlined" onPress={handleSavePin} style={styles.button}>Change PIN</Button>
        <Button mode="outlined" onPress={handleChangeSeed} style={styles.button}>Change Seed</Button>
        <Button mode="text" onPress={() => setIsSettings(false)}>Dismiss</Button>
      </View>
    );
  }
  ...
  if (!storedPin) {
    return (
      <View style={styles.container}>
        ...
        <Button mode="text" onPress={() => setIsSettings(true)}>Dismiss</Button>
      </View>
    );
  }
